...
- 🟡 **Pick a look for a hill: A (ink weight) or B (colour)**, with the "on trial" switch beside Hills, on the keyless map and over photoreal (D47). Also still unanswered: should a descent be marked on the same scale as a climb (it is, in the trial); is a hill from 1% and 5 m the right threshold (28 in New York); the sentence's wording (D48); whether the app should open with Hills already on.
