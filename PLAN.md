...
- **Palette.** Light: paper `#f4f4f0`, ink `#000`, blue `#1546ff`, grey `#8a8a86`. Dark: the inverse — ground `#000`,
  ...
  Grey *words* are darker than grey marks so they stay readable (D49). One more family, for one job: **how much**, pale
  yellow `#ffd84d`, orange `#f07f1f`, deep red `#a3150f`, on the course line and in the strip (D47: how steep a hill is).
