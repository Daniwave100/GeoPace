...
6. ✅ **The course line on the road** (#22), *built, and confirmed by the owner over real imagery in two looks on 09-18*: in photoreal the line is drawn at the road's own height, from the pipeline's
   ...
   moves too much; On the road may sit higher) and **#26** (close to the ground the Ride outruns the imagery).
...
- ✅ **The owner's look at the Ride (#8, D53)**, done 09-19 over photoreal with their own key, both courses. The verdict
  ...
  imagery not keeping up close to the ground is **#26**. Two of Claude's calls were ridden without remark and are taken
...
- **2026-09-19** — The owner rode the Ride over photoreal with their own key, which is what D53 was waiting for. It holds
  ...
  **#24** the camera moves too much between those moments and should turn to show a landmark, and On the road may sit
  ...
  by the load, D44 — but it is worth doing so a runner can't get lost, and for the keyless tiles' own terms); **#26**
