...
- 🟡 **No per-km table yet.** #5 asked for clock and elapsed time "at every km"; its acceptance criterion says "at any
  km", which scrubbing gives (Page Up/Down steps through whole kilometres). A table of splits is cheap to add; owner's call.
...
- 🔍 **Berlin 2026 waves 2–6** have no published clock time; fill them in if the organizer publishes them. Until then a
  runner in one of them types the time from their start card (D40).
