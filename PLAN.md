...
- 🟡 **The owner's ride with free look (#28, D54)**, owed: over photoreal with their own key, and under the
  ...
  **plain click** on the map should enter free look or only a drag (a click centres the runner over half a second);
  whether the map's **zoom buttons and arrow keys** should move the free camera in and out instead of taking the map;
...
- **2026-09-19** — Free look (#28, D54). In the Ride a hand on the map no longer pauses it and takes the map: a **drag
  ...
  and the owner hasn't ridden it. 415 tests.
