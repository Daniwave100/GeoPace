...
8. **Sun**: building shade (#9), then trees as a third state (#10) — **binary, sun or shade at the moment you get there, and the White model's own shadows are the map layer** (D58, settled with the owner 09-20).
