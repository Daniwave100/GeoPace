...
- 🟡 **The owner's look at the Ride (#8, D53)**, over photoreal with their own key, both courses. Everything below is
  ...
  minutes for the course, slowing to a few seconds at each Stop; on the road: about 10 minutes; too fast to take in, or
  too slow to sit through?); **On the road's height, 3 m** (does it clear what Google photographed on the road; is it
  under the Queensboro's upper deck and on the Verrazzano's upper one; would higher film better?); how the view takes
