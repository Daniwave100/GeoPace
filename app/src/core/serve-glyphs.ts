...
// shading, no gradient, which is still the poster's way with a mark (PLAN.md §6). The one rule
// kept: **water is aqua, never the course's blue**, because blue means the course and where you
// are on it and nothing else (D28), and a drop the colour of the line would say it was the line.
//
...
export const SERVE_GLYPH: Record<(typeof SHOWN_AS_GLYPHS)[number], Glyph> = {
  ...
  water: { path: "M8 1.2C8 1.2 2.6 7.5 2.6 10.6a5.4 5.4 0 0 0 10.8 0C13.4 7.5 8 1.2 8 1.2Z", name: "Water", color: "#2bb5d8" },
  ...
  "sports-drink": { path: "M9.6 0.8 3.2 9.1h3.6l-1 6.1 6.4-8.7H8.5l1.1-5.7Z", name: "Sports drink", color: "#f2a614" },
  // A sachet: a packet with a torn top, which is what a gel is.
  gel: { path: "M4.1 3.4h7.8v9.3a1.3 1.3 0 0 1-1.3 1.3H5.4a1.3 1.3 0 0 1-1.3-1.3V3.4Zm-.4-1.8 1.4.9 1.4-.9 1.5.9 1.5-.9 1.4.9 1.4-.9v1.3H3.7V1.6Z", name: "Gel", color: "#6b6b66" },
  // A round fruit with a stalk and a leaf: bananas in New York, mixed fruit in Berlin.
  fruit: { path: "M8 4.2a4.9 4.9 0 1 0 0 9.8 4.9 4.9 0 0 0 0-9.8Zm.5-.9V1.4h-1v1.9h1Zm.6-.3c1.4-.2 2.4-1 2.6-2.2-1.4.1-2.4.9-2.6 2.2Z", name: "Fruit", color: "#4caf50" },
