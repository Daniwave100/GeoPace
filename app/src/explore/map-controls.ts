...
export interface MapActions {
   ...
   * Ride plays on. Nor is Straight down, which in the Ride is a way of following the runner.
   */
  takesTheMap(): void;
  wholeCourse(): void;
  whereIAm(): void;
